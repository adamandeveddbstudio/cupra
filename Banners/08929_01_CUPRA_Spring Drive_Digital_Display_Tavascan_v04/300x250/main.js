...
function initAd() {
  ...
  tl.addLabel("frame3", "10")
    .to('#copy4,#copy5,#copy6,#disclaimer2,#disclaimer3', 0.5, { opacity: 0, ease: Power1.easeIn}, "frame3")
    .to('#disclaimer4,#disclaimer5', 0.5, { opacity: 1, ease: Power1.easeIn }, "frame3+=0.3")
    .to('#copy7', 0.5, { opacity: 1, ease: Power1.easeIn }, "frame3+=0.5")
    .to('#copy8', 0.5, { opacity: 1, ease: Power1.easeIn}, "frame3+=1.3")

  // ----------Frame 4 ------------
  tl.addLabel("frame4", "13")
    .to('#copy7,#copy8,#disclaimer4,#disclaimer5', 0.5, { opacity: 0, ease: Power1.easeIn}, "frame4")
    .to('#copy9', 0.5, { opacity: 1, ease: Power1.easeIn}, "frame4+=0.5")
    .to('#cta1', 0.5, { opacity: 1, ease: Power1.easeIn}, "frame4+=1")
  endFrame()
