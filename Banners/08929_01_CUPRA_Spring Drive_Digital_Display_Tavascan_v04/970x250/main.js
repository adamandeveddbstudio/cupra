...
function initAd() {
  ...
  tl.addLabel("frame3", "10")
    .to('#copy4,#copy5,#copy6,#copy7,#copy8,#disclaimer2', 0.5, { opacity: 0, ease: Power1.easeIn}, "frame3")
    .to('#disclaimer3,#disclaimer4', 0.5, { opacity: 1, ease: Power1.easeIn }, "frame3+=0.3")
