...
function initAd() {
  ...
  tl.addLabel("frame2", "5")
    ...
    .to('#copy7,#copy8', 0.5, { opacity: 1, ease: Power1.easeIn}, "frame2+=2.6")
    .to('#copy9', 0.5, { opacity: 1, ease: Power1.easeIn}, "frame2+=3.4")

  // ----------Frame 3 ------------
  tl.addLabel("frame3", "10")
    .to('#copy4,#copy5,#copy6,#copy7,#copy8,#disclaimer2,#disclaimer3,#copy1,#copy9', 0.5, { opacity: 0, ease: Power1.easeIn}, "frame3")
